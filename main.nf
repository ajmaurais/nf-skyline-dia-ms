...
workflow {
    ...
    all_mzml_hash_ch = null   // hold all mzML file names and hashes
    all_elib_ch = null       // hold all elibs generated by encyclopedia
    all_elib_hash_ch = null  // hold all encyclopedia output file names and hashes
    ...
    if(params.msconvert_only) {
        ...
        if(params.chromatogram_library_spectra_dir != null) {
            ...
            all_mzml_hash_ch = get_narrow_mzmls.out.file_hash_ch
        } else {
    ...
    if(params.pdc.study_id == null) {
        ...
        wide_mzml_ch = get_wide_mzmls.out.mzml_ch
        all_mzml_hash_ch = get_wide_mzmls.out.file_hash_ch
        ...
        if(params.quant_spectra_dir == null) {
            ...
            all_mzml_hash_ch = get_pdc_files.out.file_hash_ch
    ...
    if(params.search_engine.toLowerCase() == 'encyclopedia') {
        ...
        if(params.chromatogram_library_spectra_dir != null) {
            ...
            all_mzml_ch = wide_mzml_ch.concat(narrow_mzml_ch)
            all_mzml_hash_ch = all_mzml_hash_ch.concat(narrow_mzml_ch)
        ...
        all_elib_hash_ch = Channel.empty()
        all_mzml_ch = wide_mzml_ch
    ...
    if(!params.skyline.skip) {
        ...
        if(!params.qc_report.skip)
        {
            ...
            if(params.pdc.gene_level_data != null) {
                EXPORT_GENE_REPORTS(generate_dia_qc_report.out.qc_report_db, pdc_study_name)
